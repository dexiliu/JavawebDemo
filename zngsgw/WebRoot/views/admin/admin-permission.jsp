...
<body>
<nav class="breadcrumb"><i class="iconfont">&#xf012b;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 权限管理 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="icon-refresh"></i></a></nav>
<div class="pd-20">
  <div class="text-c">
    <form class="Huiform" method="post" action="" target="_self">
      <input type="text" placeholder="权限名称" autocomplete="off" value="" class="input-text" style="width:150px">
      <input type="text" placeholder="字段名" autocomplete="off" value="" class="input-text" style="width:150px">
      
      <button type="button" class="btn btn-success" id="" name="" onClick="admin_permission_add();"><i class="icon-plus"></i> 添加权限节点</button>
    </form>
  </div>
  ...
  <table class="table table-border table-bordered table-bg">
    ...
    <tbody>
      <tr class="text-c">
        ...
        <td>栏目添加</td>
        <td></td>
        <td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_permission_edit('1','400','310','角色编辑','admin-permission-edit.jsp')" class="ml-5" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="admin_permission_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
      </tr>
