  ...
  <table class="table table-border table-bordered table-hover table-bg">
    ...
    <tbody>
      <tr class="text-c">
        ...
        <td>拥有至高无上的权利</td>
        <td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('1','750','','角色编辑','admin-role-add.jsp')" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
      </tr>
      <tr class="text-c">
        <td><input type="checkbox" value="" name=""></td>
        <td>2</td>
        ...
        <td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('2','750','','角色编辑','admin-role-add.jsp')" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
      </tr>
      <tr class="text-c">
        <td><input type="checkbox" value="" name=""></td>
        <td>3</td>
        ...
        <td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('3','750','','角色编辑','admin-role-add.jsp')" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
      </tr>
      <tr class="text-c">
        <td><input type="checkbox" value="" name=""></td>
        <td>4</td>
        ...
        <td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('4','750','','角色编辑','admin-role-add.jsp')" style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a></td>
      </tr>
    </tbody>
  </table>
</div>
