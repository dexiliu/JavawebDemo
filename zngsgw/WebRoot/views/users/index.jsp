...
<aside class="Hui-aside">
  ...
  <div class="menu_dropdown bk_2">
    <dl id="menu-user">
      ...
      <dd>
        <ul>
          <li><a _href="<%=basePath%>views/users/user-list.jsp" href="javascript:;">用户管理</a></li>
          <li><a _href="<%=basePath%>views/users/user-list-del.jsp" href="javascript:;">删除的用户</a></li>
          <li><a _href="<%=basePath%>views/users/user-list-black.jsp" href="javascript:;">黑名单</a></li>
          <li><a _href="<%=basePath%>views/users/record-browse.jsp" href="javascript:void(0)">浏览记录</a></li>
          <li><a _href="<%=basePath%>views/users/record-download.jsp" href="javascript:void(0)">下载记录</a></li>
          <li><a _href="<%=basePath%>views/users/record-share.jsp" href="javascript:void(0)">分享记录</a></li>
        </ul>
      </dd>
    </dl>
    <dl id="menu-comments">
...
<section class="Hui-article-box">
  <div id="Hui-tabNav" class="Hui-tabNav">
    <div class="Hui-tabNav-wp">
      <ul id="min_title_list" class="acrossTab cl">
        <li class="active"><span title="我的桌面" data-href="<%=basePath%>view/users/welcome.jsp">我的桌面</span><em></em></li>
      </ul>
    </div>
  ...
  <div id="iframe_box" class="Hui-article">
    <div class="show_iframe">
      ...
      <iframe scrolling="yes" frameborder="0" src="<%=basePath%>views/users/welcome.jsp"></iframe>
    </div>
  </div>
</section>
